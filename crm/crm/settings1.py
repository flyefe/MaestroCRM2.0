...
ALLOWED_HOSTS = os.getenv('DJANGO_ALLOWED_HOSTS', 'g-linecrm.fly.dev,127.0.0.1').split(',')
...
# ALLOWED_HOSTS = config('ALLOWED_HOSTS', 'g-linecrm.fly.dev,127.0.0.1,crm-quiet-hill-1806.fly.dev').split(',')
